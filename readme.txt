...
= 1. Install the Coinsnap for GiveWP plugin from the WordPress plugin repository =
...
[https://github.com/Coinsnap/Coinsnap-for-GiveWP/](https://github.com/Coinsnap/Coinsnap-for-GiveWP/)

== Frequently Asked Questions ==

See the FAQ on [https://coinsnap.io/coinsnap-for-givewp-installation-guide/](https://coinsnap.io/coinsnap-for-givewp-installation-guide/)

== Screenshots ==

1. Coinsnap for GiveWP Add-on
2. GiveWP Plugin for Wordpress
3. Plugin downloading from Github repository
4. Manual plugin installation
5. Payment gateways list
...
* Compatibility with GiveWP 4.14.4 is tested.
