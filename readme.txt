...
Stable tag: 1.0.0
License: MIT
License URI: https://github.com/Coinsnap/Coinsnap-for-GiveWP/blob/main/license.txt
...
If you don’t want to install add-on directly via plugin, you can download Coinsnap GiveWP form add-on from Coinsnap Github page or from WordPress directory and install it via “Upload Plugin” function:
